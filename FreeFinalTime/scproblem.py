...
class SCProblem:
    ...
    def __init__(self, m, K):
        ...
        self.var['Gamma'] = cvx.Variable((1, K))
        ...
        self.par['G_bar'] = cvx.Parameter((m.n_x, K - 1))
        self.par['H_bar'] = cvx.Parameter((m.n_x, K - 1))
        ...
        # Model:
        constraints += m.get_constraints(self.var['X'], self.var['U'], self.var['Gamma'], self.par['X_last'], self.par['U_last'])
        ...
        constraints += [
            ...
            + cvx.reshape(self.par['G_bar'][:, k], (m.n_x, 1)) * self.var['Gamma'][:, k]
            + cvx.reshape(self.par['H_bar'][:, k], (m.n_x, 1)) * self.var['Gamma'][:, k + 1]
